...
if (isTesisPage) {
  ...
  const initCarousel = (carousel) => {
    ...
    window.addEventListener("resize", () => {
      setViewportOffset(viewport.clientWidth * currentIndex);
    });
    renderCarousel();
  };
  ...
  const pawPalette = {
    "datos-academicos": { soft: "rgba(255, 255, 255, 0.12)", strong: "rgba(255, 255, 255, 0.26)", accent: "#ececec" },
    instituciones: { soft: "rgba(255, 228, 171, 0.16)", strong: "rgba(255, 228, 171, 0.34)", accent: "#ffe7ba" },
    introduccion: { soft: "rgba(173, 216, 255, 0.16)", strong: "rgba(173, 216, 255, 0.34)", accent: "#cbe6ff" },
    objetivos: { soft: "rgba(171, 197, 255, 0.16)", strong: "rgba(171, 197, 255, 0.34)", accent: "#ceddff" },
    metodologia: { soft: "rgba(162, 235, 213, 0.16)", strong: "rgba(162, 235, 213, 0.34)", accent: "#c5f3e4" },
    arquitectura: { soft: "rgba(197, 178, 255, 0.16)", strong: "rgba(197, 178, 255, 0.34)", accent: "#ddceff" },
    modulos: { soft: "rgba(255, 212, 150, 0.16)", strong: "rgba(255, 212, 150, 0.34)", accent: "#ffdca8" },
    resultados: { soft: "rgba(149, 245, 194, 0.16)", strong: "rgba(149, 245, 194, 0.34)", accent: "#bdf8d5" },
    justificacion: { soft: "rgba(255, 194, 173, 0.16)", strong: "rgba(255, 194, 173, 0.34)", accent: "#ffd6c8" },
    diagramas: { soft: "rgba(168, 224, 255, 0.16)", strong: "rgba(168, 224, 255, 0.34)", accent: "#c6ebff" },
    "pruebas-calidad": { soft: "rgba(168, 224, 255, 0.16)", strong: "rgba(168, 224, 255, 0.34)", accent: "#c6ebff" },
    "estimacion-costos": { soft: "rgba(255, 217, 163, 0.18)", strong: "rgba(255, 217, 163, 0.36)", accent: "#ffe2b8" },
    conclusiones: { soft: "rgba(245, 184, 255, 0.16)", strong: "rgba(245, 184, 255, 0.34)", accent: "#f4ccff" },
  };
